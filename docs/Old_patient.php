      ...
      <div class="row"  >
        ...
        <?php
              if(isset($_POST['submit']))
              {
                ...
                $insertquery="INSERT INTO patients (patient_name,patient_father_name,disease,CNIC_No,patient_dob,patient_cell_no,Savera_q, XOLOX_q, DAKLANA_q, p_gender, p_age, p_address) VALUES('$p_name','$p_father_name','$disease','$p_cnic','$p_dob','$p_cell_no','$Savera_q', '$XOLOX_q', '$DAKLANA_q','$p_gender', '$p_age', '$p_address')";
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" name="p_dob" id="dob" class="form-control">
                  </div>
                  <div class="form-group">
