<?php 
    ...
    include('header.php');
    include('sidebar.php');
$chek=$_SESSION['admin_email'];
 ?>

    <main class="app-content" style="margin-top: 10px;">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i>Hepatitis_C</h1>
          <p>Table to display Hepatitis_C Patients list</p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Patient Lists</li>
          <li class="breadcrumb-item active"><a href="#">Hepatitis_C</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="tile-body">
              <table class="table table-hover table-bordered" id="sampleTable">
                ...
                <tbody>
                  <?php 
                         $nmbr=1;
                          $selectQ="SELECT patient_name, patient_father_name, CNIC_No, patient_dob, patient_cell_no, disease, patient_stars, patient_cell_no, p_address FROM `patients` WHERE disease='Hepatitis_C' ORDER BY `patient_id`  DESC ";
